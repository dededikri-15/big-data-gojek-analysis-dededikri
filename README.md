...
- **Variety:** Terdiri dari data terstruktur dari _Log Transaksi_ (`score`, `appVersion`, `at`) dan data tidak terstruktur dari _Media Teks_ (`content`)[cite: 2].
- **Velocity:** Pengumpulan data ulasan otomatis dari server Google Play Store melalui proses _crawling_ bertahap secara cepat[cite: 2].
- **Veracity:** Proses pembersihan (_Data Cleaning_) menggunakan Pandas untuk menjamin keakuratan dan keandalan data[cite: 2].
...
![Rancangan Arsitektur Big Data Management](https://raw.githubusercontent.com/dededikri-15/big-data-gojek-analysis-dededikri/main/arsitektur.png)
_Gambar 1: Rancangan Arsitektur Big Data Management_[cite: 2]

### 2. Pengecekan Data pada MongoDB Compass

![Memasukan File CSV Clean ke MongoDb](https://raw.githubusercontent.com/dededikri-15/big-data-gojek-analysis-dededikri/main/mongodb_compass.png)
_Gambar 2: Verifikasi 50.000 Data Bersih di MongoDB Compass_[cite: 2]

### 3. Diagram Fungsional Big Data

![Diagram Fungsional Big Data Management](https://raw.githubusercontent.com/dededikri-15/big-data-gojek-analysis-dededikri/main/diagram_fungsional.png)
_Gambar 3: Diagram Fungsional Big Data Management (Konsep 5V)_[cite: 2]

---

## 📊 Analisis & Visualisasi Data (Power BI)

![Dashboard Analisis Power BI](https://raw.githubusercontent.com/dededikri-15/big-data-gojek-analysis-dededikri/main/powerbi_dashboard.png)
_Gambar 4: Dasbor Analisis Keseluruhan pada Power BI_[cite: 2]

**Fokus Analisis:**

1. **Tingkat Kepuasan Pengguna (Skor Bintang):** Memetakan tingkat kepuasan pelanggan secara keseluruhan[cite: 2].
2. **Tren Aktivitas Ulasan Pengguna:** Memantau fluktuasi jumlah ulasan dari waktu ke waktu[cite: 2].
3. **Perbandingan Rata-Rata Kepuasan per Versi Aplikasi:** Mengevaluasi kualitas teknis dari setiap update aplikasi[cite: 2].
4. **Volume Pergerakan Ulasan:** Visualisasi kepadatan interaksi pengguna[cite: 2].
5. **Daftar Kontribusi Ulasan Pengguna:** Menunjukkan proporsi keterlibatan pengguna[cite: 2].
6. **Ulasan Paling Bermanfaat:** Menyoroti opini pengguna yang memiliki `thumbsUpCount` tertinggi[cite: 2].

---

## 🎨 Rancangan Tampilan Antarmuka (UI Dashboard Canva)

![Rancangan Tampilan UI Dashboard](https://raw.githubusercontent.com/dededikri-15/big-data-gojek-analysis-dededikri/main/ui_canva.png)
_Gambar 5: Rancangan Tampilan Antarmuka (UI) Dashboard Analisis Ulasan Pengguna Gojek_[cite: 2]
...
3.Jalankan Proses Ingestion / Crawling Data:
Bash
